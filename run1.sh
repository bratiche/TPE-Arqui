...
qemu-system-x86_64 -hda Image/x64BareBonesImage.qcow2 -m 512 -vga std -no-kvm-irqchip -device rtl8139,netdev=net0,mac=52:54:AB:CD:EF:13 -netdev tap,id=net0,ifname=tap1,script=no,downscript=no
